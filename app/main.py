"""
Main application entry point for the GitHub Issues Service.
...
* provides standardized request validation error handling;
* registers request ID and structured logging middleware; and
